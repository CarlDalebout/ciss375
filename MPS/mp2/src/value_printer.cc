...
static void embed_getelementptr(ostream &o, op_type type, operand op1,
 ...
 */
void ValuePrinter::getelementptr(ostream &o, op_type type, operand op1,
...
void ValuePrinter::getelementptr(ostream &o, op_type type, vector<operand> op,
                                 operand result) {
  check_ostream(o);
  o << "\t";
  if (result.get_type().get_id() != VOID)
...
operand ValuePrinter::getelementptr(op_type type, vector<operand> op,
                                    op_type result_type) {
  operand result = make_fresh_operand(result_type);
